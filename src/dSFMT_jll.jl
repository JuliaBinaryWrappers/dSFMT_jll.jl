...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import dSFMT_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("05ff407c-b0c1-5878-9df8-858cc2e60c36"))
platforms = [Pkg.Artifacts.unpack_platform(e, "dSFMT", artifacts_toml) for e in artifacts["dSFMT"]]
...
if best_platform === nothing
    @debug("Unable to load dSFMT; unsupported platform $(triplet(platform_key_abi()))")
else
